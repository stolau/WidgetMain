"use strict";
	...
	function sendGraph(valueList, name)
	{
		...
		for(var i = 0; i < valueList.length; i++)
		{
			...
			{
				seriesDict.push(parseFloat(valueList[i][d][1]));
	...
	function createButton(nameBtn, idBtn, classBtn, servicePath, service) {
		...
		if (classBtn == "buttonGraph")
		{
			...
			// var atts = browser(url, headers);
			// console.log(atts);
			
			url = "http://pan0107.panoulu.net:8000/comet/STH/v1/contextEntities/type/AirQualityObserved/id/" + "11120" + "/attributes/tk11te22?lastN=20"
